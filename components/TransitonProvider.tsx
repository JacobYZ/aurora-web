  ...
  return (
    <AnimatePresence mode="wait">
      <div
        ...
        <motion.div
          className="h-screen w-screen fixed bg-stone-300 rouned-b-[100px] z-10"
          animate={{ height: "0vh" }}
          exit={{ height: "140vh" }}
          transition={{ duration: 0.5, ease: "easeOut" }}
        />
        <motion.div
          className="fixed m-auto top-0 bottom-0 left-0 right-0 w-fit h-fit text-8xl cursor-default text-black font-bold z-20"
          initial={{ opacity: 1 }}
          animate={{ opacity: 0 }}
          exit={{ opacity: 0 }}
